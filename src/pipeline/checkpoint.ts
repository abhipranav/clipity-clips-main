...
import { PipelineStage, StageStatus, type PipelineRun, type StageResult, type ClipProgressSnapshot } from "./types";
...
export class CheckpointManager {
  ...
  getClipProgressList(runId: string): ClipProgressSnapshot[] {
    const rows = this.db
  ...
  getStageResults(runId: string): StageResult[] {
    const rows = this.db
