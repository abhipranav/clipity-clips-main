...
import { DEFAULT_RESOLVED_OPTIONS } from "../../src/job-options/types";
...
describe("VideoProcessor", () => {
  ...
  test("composeSingleReel (no subway surfers) produces 9:16 output", async () => {
    ...
    const result = await vp.composeReel(TEST_VIDEO, config, outputPath, DEFAULT_RESOLVED_OPTIONS, null);
